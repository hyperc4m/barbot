...
docker_compose_path = os.path.normpath(os.path.join(__file__, '..', 'docker-compose.yaml'))

NGROK_TARGET_PORT = re.search('host.docker.internal:([0-9]+)', pathlib.Path(docker_compose_path).read_text()).group(1)
